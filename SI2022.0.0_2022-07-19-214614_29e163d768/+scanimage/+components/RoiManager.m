classdef RoiManager < scanimage.interfaces.Component
    ...
    methods
        ...
        function set.mroiEnable(obj,val)
            ...
            if isprop(obj.hSI.hScanner, 'isPolygonalScanner') && obj.hSI.hScanner.isPolygonalScanner && val
               most.gui.blockingMsgbox('MROI feature not available when polygonal scanning.', 'Notice');
               obj.mroiEnable = false;
               return;
            end
        ...
        function set.pixelsPerLine(obj,val)
            ...
            if obj.hSI.hScanner.isPolygonalScanner
